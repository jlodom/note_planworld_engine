...
$pathClientPrefix = '/web/path/to/this/directory/from/the/server/url';
/* If your server serves this file from http://www.mycorp.com/stuff/planworld/client then the above would be /stuff/planworld/client */
